...
The elders demand more moos! A game for the Commodore 64. 

[Download on itch.io](https://softwave.itch.io/weirdvision-64). 

This is my first game written in assembly language. It is a followup to a small Flash game [I wrote years ago](https://softwave.itch.io/weirdvision). It's been run on real C64 hardware, but it can also be played in a browser-based emulator. The PRG and D64 files are there, also. 
...
You play as a "squiddle", or, an "Oiquean", a small, squid-like creature that lives on a now desert world ([the same world explored in some of my other projects](https://softwave.itch.io/drifter)). 
