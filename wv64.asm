    ...
    // A warning, there's a lot of bad code here!
    // I learned assembly as I went

    // Play on itch.io: https://softwave.itch.io/weirdvision-64
    // GitHub: https://github.com/Softwave/Weirdvision-64
